...
void I2CANSG08Input::setup() {
  ...
  //                         options.i2cAddress0);
  ansg08s[0] = new ANSG08(i2c, options.i2cAddress0);
  ansg08s[0]->begin();

  // ansg08s[1] = new ANSG08(options.i2cSDAPin, options.i2cSCLPin,
  //                         options.i2cBlock == 0 ? i2c0 : i2c1, options.i2cSpeed,
  //                         options.i2cAddress1);
  ansg08s[1] = new ANSG08(i2c, options.i2cAddress1);
  ansg08s[1]->begin();

  // ansg08s[2] = new ANSG08(options.i2cSDAPin, options.i2cSCLPin,
  //                         options.i2cBlock == 0 ? i2c0 : i2c1, options.i2cSpeed,
  //                         options.i2cAddress2);
  ansg08s[2] = new ANSG08(i2c, options.i2cAddress2);
  ansg08s[2]->begin();

  // ansg08s[3] = new ANSG08(options.i2cSDAPin, options.i2cSCLPin,
  //                         options.i2cBlock == 0 ? i2c0 : i2c1, options.i2cSpeed,
  //                         options.i2cAddress3);
  ansg08s[3] = new ANSG08(i2c, options.i2cAddress3);
  ansg08s[3]->begin();
}
...
void I2CANSG08Input::process() {
  ...
  gamepad->state.ry = static_cast<uint16_t>(((options.reverse ? bitReverse(statuses[0]) : statuses[0]) ^ 0x80) << 8);
  gamepad->state.rx = static_cast<uint16_t>(((options.reverse ? bitReverse(statuses[1]) : statuses[1]) ^ 0x80) << 8);
  gamepad->state.ly = static_cast<uint16_t>(((options.reverse ? bitReverse(statuses[2]) : statuses[2]) ^ 0x80) << 8);
  gamepad->state.lx = static_cast<uint16_t>(((options.reverse ? bitReverse(statuses[3]) : statuses[3]) ^ 0x80) << 8);
}